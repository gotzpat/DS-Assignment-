...
For example, _marital status_ has a highly significant p-value (2.66e-09) but explains less than 1% of variance (η² = 0.009), indicating negligible practical importance. In contrast, _Curricular units 2nd sem (grade)_ explains 34% of variance (η² = 0.339), representing a large and meaningful effect. When identifying important predictors, the features with larger effect sizes should be prioritized rather than relying only on p-values. 
...
display(Markdown("""ADD A SMALL TRANSITION"""))
